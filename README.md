# Medical Prescription & Receipt Studio 🩺

A professional, high-precision web-based Medical Prescription & Receipt Studio modeled after Dr. Aparna T's dermatology clinic format.

## Features ✨
- **Exact Layout & Typography**: Modeled after standard clinical prescription format with doctor credentials, clinic contact details, and Rx symbols.
...
This project is configured to run for free on **GitHub Pages**.

1. Create a repository on GitHub (e.g. `medical-prescription-studio`).
